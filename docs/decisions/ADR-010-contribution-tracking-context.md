...
**착수 시 가설은 "랭킹이 멈췄다"였다. 프로덕션 진단이 그것을 뒤집었다.** 공개 API가 4명분 2026년 수치를 반환하고 있었고 숫자는 존재했으나 갱신이 서지 않았다. 원인 진단은 별건이지만, 이 사고가 드러낸 구조적 사실은 하나다 — **랭킹이 조직 저장소 sweep의 건강에 종속돼 있어 sweep이 멈추면 학생이 보는 화면이 같이 멈춘다.**
