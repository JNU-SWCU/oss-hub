...
- root와 적용되는 nested `AGENTS`를 준수했고 독립 Code Owner review와 review conversation이 완료됐다.
- correctness·security·명시적 계약 위반만 blocker로 분류하며, 그 밖의 개선은 비차단 의견이나 후속 Issue로 남긴다.
