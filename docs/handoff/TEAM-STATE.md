...
| 프로필 완료 전 역할 선택 차단 | @Lumiere001 | active | [#212](https://github.com/JNU-SWCU/oss-hub/issues/212) | 로컬 종속 후보 `codex/onboarding-profile-gate` | 로컬 검증 중 · GitHub CI 미실행 | #153 프로필 후보가 선행. 최종 PR 생성·exact-head Code Owner 검토 필요 |
