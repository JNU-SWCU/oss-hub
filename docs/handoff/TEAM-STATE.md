...
| Jenkinsfile thinning 실행 계획 | @GoBeromsu | planned | #380 | - | - | G0: `scripts/jenkins/**`의 ADR-005 deploy-contract path 보호 적용 여부 확인 선행 · 후속 추출 PR 전부 HIGH_RISK·@GoBeromsu PM_ACCEPT 필요 |
