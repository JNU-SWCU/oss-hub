...
| 공개 쇼케이스 allowlist projection | @GoBeromsu | review | [#266](https://github.com/JNU-SWCU/oss-hub/issues/266) | PR pending | backend 663(신규 showcase 8 포함) · frontend 전체 · lint/typecheck/build pass | 직렬 schema migration · 적격성=PUBLIC∧APPROVED∧endAt 경과(fail-closed) · 동기 revoke · #126/#134 선행 |
