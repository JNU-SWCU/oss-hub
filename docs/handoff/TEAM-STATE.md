...
| 교직원 운영 대시보드 프로그램 직접 편집 진입 | @Geuin04 | review | [#481](https://github.com/JNU-SWCU/oss-hub/issues/481) | [#411](https://github.com/JNU-SWCU/oss-hub/pull/411) | frontend focused 11 · lint/typecheck/build · authenticated browser 375/768/1280 재검증 | 없음 — 실제 편집 Link를 행 주 액션으로 제공하고 신청자 링크와 분리, 모바일 표 내부 스크롤 유지 |
