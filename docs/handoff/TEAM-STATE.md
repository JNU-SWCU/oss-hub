...
| 관리자 수집 시스템 상태 | @Lumiere001 | review | #133 | [#260](https://github.com/JNU-SWCU/oss-hub/pull/260) | backend unit 795 · integration 140 · frontend 441 · lint/typecheck/build/format/public-safe · authenticated Aside pass | PM path exception · owner @Lumiere001 사후 확인 필요 |
...
| GitHub 저장소 주기 수집 스케줄러 | @GoBeromsu | review | #151 | [#260](https://github.com/JNU-SWCU/oss-hub/pull/260) | canonical REST unit/integration · backend unit 795 · integration 140 · frontend 441 · lint/typecheck/build/format/public-safe | Collection App 설치·secret 주입·승인된 private 합성 fixture가 없어 E1과 후속 C2 retirement 보류(unblock: @GoBeromsu) |
