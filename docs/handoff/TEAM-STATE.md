...
| GitHub App 인증·REST read 최소 권한 계약 | @Lumiere001 | done | #120 #205 | [#208](https://github.com/JNU-SWCU/oss-hub/pull/208) merged | pass | 실제 Repository Operations App live smoke는 다음 행의 별도 게이트 |
| 저장소 자동 생성·팀원 초대 | @Lumiere001 | active | #121 #205 | [#204](https://github.com/JNU-SWCU/oss-hub/pull/204) Draft | automated pass | 코드·자동 검증 완료. JNU-SWCU canonical org의 승인된 Operations App installation·credential 주입과 live smoke 대기; 증거 전 Draft·Issue 유지 |
...
| 교직원 제출 검토·명시적 저장소 공개 | @jinsol1190-rgb (구현 @Lumiere001) | active | #125 #121 | Draft 예정, #204 위 stacked | local pass | 최신 revision 단일 판정·이력·별도 공개 구현 및 브라우저 점검 완료. 선행 PR #204 merge 전에는 병합하지 않음 |
...
- stale — `source_commit` 이후 #191·#195·#198·#210이 병합됐다. 이 PR에서는 #191·#208·#210 관련 행만 부분 갱신했으며 전체 스냅샷 갱신은 별도로 필요하다.
