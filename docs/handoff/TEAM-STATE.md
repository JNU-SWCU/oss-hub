...
| 학생 내 대시보드 조회 API | @jinsol1190-rgb | review | [#114](https://github.com/JNU-SWCU/oss-hub/issues/114) | PR pending | backend 650(신규 dashboard 10 포함) · frontend 408 · lint/typecheck/build pass | 누락됐던 backend GET /api/v1/dashboard/student 구현 · owner 사후 확인 필요 |
