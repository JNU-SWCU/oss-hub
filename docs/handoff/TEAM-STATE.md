...
| PR #256 일회성 긴급 PM 코드 승인 정책 | @GoBeromsu | review | [#257](https://github.com/JNU-SWCU/oss-hub/issues/257) | [#258](https://github.com/JNU-SWCU/oss-hub/pull/258) merged · [#259](https://github.com/JNU-SWCU/oss-hub/pull/259) Draft | #258 merge SHA `1b541306ef96ac0ddc17681541bd6538e5412382`의 최초 checker는 긴급 경로 비활성 · #259 fixture 44/44 local pass | #259를 기존 `HIGH_RISK` gate로 검증·병합한 뒤에만 PR #256 긴급 marker 발행 가능(unblock: @Lumiere001) |
