...
| 공개 아카이브 목록·상세 | @jinsol1190-rgb | review | [#126](https://github.com/JNU-SWCU/oss-hub/issues/126) | PR pending | backend 669(신규 showcase public 6) · frontend 78 files(신규 archive) · lint/typecheck/build pass | projection-only 익명 API · private/비존재 구분 불가 404 · owner 사후 확인 필요 |
