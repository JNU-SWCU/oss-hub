...
| Program & Intake 백로그(10건: 프로그램 생성·편집·목록·상세·신청·팀 구성·신청자 목록·신청 폼·승인 트리거) | @Geuin04 | active (#101 #102 #118) · review (#103) | #100 #101 #102 #103 #104 #105 #106 #117 #118 #119 | [#189](https://github.com/JNU-SWCU/oss-hub/pull/189) merged · #191 Draft · [#195](https://github.com/JNU-SWCU/oss-hub/pull/195) Ready for review | #189 pass · #195 pending | #103 Tech Lead 추가 리뷰(공개/인증 경계·재제출 URL·오류 노출·역할별 화면 증거) 대응 중 · #100 병합으로 #101·#104·#118 착수 가능 |
