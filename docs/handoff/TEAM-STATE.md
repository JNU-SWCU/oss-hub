...
| Participation & Showcase 백로그(8건: 내 대시보드·마일스톤 제출·재제출·운영 대시보드·매트릭스·검토·공개 아카이브·알림) | @jinsol1190-rgb | planned | #114 #115 #116 #124 #125 #126 #127 #134 | - | - | 없음 — 코어 스키마(done) 전제 충족 |
| 학생 마일스톤 타임라인 | @jinsol1190-rgb | review | #155 | [#232](https://github.com/JNU-SWCU/oss-hub/pull/232) Draft | local pass | #116 마일스톤 체크리스트 endpoint 미병합 — production은 synthetic data 없이 fail-closed |
