...
| 마감 알림 메일 + 수신 이메일 설정(모달) | @GoBeromsu | review | #127 | 준비 중 | local pass (backend unit 448·integration 86 · frontend 228 · nest build) | 실 Gmail OAuth 발송 실증은 팀 Notion 자격 필요(human-blocked) · dry-run 어댑터·통합테스트로 dev/CI 검증 · Tech Lead Review @Lumiere001 |
