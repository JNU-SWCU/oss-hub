...
| Program & Intake 계획 백로그(5건: 신청·팀 구성·신청자 목록·신청 폼·운영 대시보드) | @GoBeromsu | active | #104 #105 #106 #117 #118 | - | local pass | PM path exception · `feat/program-intake` 로컬 구현(#118→#104→#105→#106→#117) · Draft PR 전 · owner 사후 확인 요청 |
