...
| webhook 처리 결과 관측 지표 | @Lumiere001 | review | #215 | [#216](https://github.com/JNU-SWCU/oss-hub/pull/216) Draft | 로컬 pass | 직렬 migration을 위해 #211 위에 stacked · #211 병합 전 main 대상 병합 금지 |
