...
| 마일스톤 최초 제출(TEXT·REPOSITORY_RELEASE) | @Lumiere001 | active | #115 | Draft PR 생성 예정 | 로컬 pass | FILE은 private storage와 프로그램 종료일 기준 PM 결정 대기 · 실제 저장소 E2E는 #121 live smoke 이후 |
