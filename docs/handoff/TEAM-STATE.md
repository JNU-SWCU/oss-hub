...
| 관리자 수집 시스템 상태 | @Lumiere001 | review | #133 | - | backend unit 775 · integration 140 · frontend 441 · lint/typecheck/build/format/public-safe · authenticated Aside pass | PM path exception · owner @Lumiere001 사후 확인 필요 |
...
| 마일스톤 FILE 제출·보존 수명주기 | @Lumiere001 | review | #115 | - | PostgreSQL+MinIO integration · backend unit 775 · frontend 441 · lint/typecheck/build/format/public-safe · authenticated Aside pass | production S3-compatible smoke 대기(unblock: @GoBeromsu) · PM path exception · owner @Lumiere001 사후 확인 필요 |
...
| GitHub 저장소 주기 수집 스케줄러 | @GoBeromsu | review | #151 | - | canonical REST unit/integration · backend unit 775 · integration 140 · frontend 441 · lint/typecheck/build/format/public-safe | Collection App 설치·secret 주입·승인된 private 합성 fixture가 없어 E1과 후속 C2 retirement 보류(unblock: @GoBeromsu) |
