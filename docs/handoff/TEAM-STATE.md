...
| Program & Intake 백로그(10건: 프로그램 생성·편집·목록·상세·신청·팀 구성·신청자 목록·신청 폼·승인 트리거) | @Geuin04 | active (#101 #102 #118) · review (#103) | #100 #101 #102 #103 #104 #105 #106 #117 #118 #119 | [#189](https://github.com/JNU-SWCU/oss-hub/pull/189) merged · #191 Draft · [#195](https://github.com/JNU-SWCU/oss-hub/pull/195) Ready for review | #189 pass · #195 재검증 예정 | #103 추가 리뷰(URL·오류/빈 상태 테스트·ADR-003 전체 서비스 경계) 대응 완료, push·CI 대기 · #100 병합으로 #101·#104·#118 착수 가능 |
