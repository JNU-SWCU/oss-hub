...
| 학생 마일스톤 타임라인 FILE 제출 차단 | @jinsol1190-rgb | review | [#155](https://github.com/JNU-SWCU/oss-hub/issues/155) | PR pending | frontend 408 · timeline focused 9 · lint/typecheck/build pass | FILE 마일스톤은 `파일 제출 준비 중` disabled 표시, 제출/재제출 링크 비노출 · #115 FILE 업로드 후속 |
