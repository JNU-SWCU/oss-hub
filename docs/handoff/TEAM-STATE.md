...
| 환경 변수 응집·배포 파이프라인 단순화 | @GoBeromsu | active | [#305](https://github.com/JNU-SWCU/oss-hub/issues/305) | [#306](https://github.com/JNU-SWCU/oss-hub/pull/306)·[#307](https://github.com/JNU-SWCU/oss-hub/pull/307)·[#309](https://github.com/JNU-SWCU/oss-hub/pull/309)·[#310](https://github.com/JNU-SWCU/oss-hub/pull/310)·[#311](https://github.com/JNU-SWCU/oss-hub/pull/311) merged · [#312](https://github.com/JNU-SWCU/oss-hub/pull/312)·[#313](https://github.com/JNU-SWCU/oss-hub/pull/313) active · [#314](https://github.com/JNU-SWCU/oss-hub/pull/314) Draft | G005 checker 106 cases · backup pruner 35 cases · root `Jenkinsfile` diff 0 | G005는 `deploy/jenkins/Jenkinsfile.v2` candidate라 병합만으로 운영 동작 없음 · C4 N=120 same-code 격리 fixture 완료 · C3 immutable legacy verification job은 Jenkins admin 권한 필요 · activation·host nginx 설치·Release 실증은 별도 HIGH_RISK 점검 창 |
