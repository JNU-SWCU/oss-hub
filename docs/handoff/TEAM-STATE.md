...
| PR #256 일회성 긴급 PM 코드 승인 정책 | @GoBeromsu | review | [#257](https://github.com/JNU-SWCU/oss-hub/issues/257) | [#258](https://github.com/JNU-SWCU/oss-hub/pull/258) | fixture 42/42·format·lint·typecheck·unit·build local pass | amendment를 기존 `HIGH_RISK` gate로 병합하기 위한 @Lumiere001의 current-head `TECH_LEAD_ACCEPT` 대기(unblock: @Lumiere001) |
