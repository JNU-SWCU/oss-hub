...
| Jenkins rollback 이미지 사전 검증 스크립트 추출 | @GoBeromsu | review | [#379](https://github.com/JNU-SWCU/oss-hub/issues/379) | - | 스크립트 계약 fixture 18/18 pass · checker fixture 94/94 pass · Jenkinsfile 계약 pass · Jenkinsfile 700→641줄 | 배포 EC2에서 실행 중 deployment의 실제 PREV_* 값으로 read-only 실행 검증 미수행 (unblock: @GoBeromsu) |
