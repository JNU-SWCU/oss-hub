...
| Access & GitHub Platform 백로그(14건: 로그인 이력·온보딩 프로필·설정·관리 콘솔·감사 로그·시스템 상태·저장소 자동화·webhook 확장 등) | @Lumiere001 (예외: #98은 @Geuin04 배정) | planned | #98 #99 #107 #108 #120 #121 #122 #123 #131 #132 #133 #153 #156 #157 | - | - | GitHub App 인증 ADR(#120)이 저장소 자동 생성(#121)·webhook 확장(#123)의 선행 |
| Program & Intake 백로그(10건: 프로그램 생성·편집·목록·상세·신청·팀 구성·신청자 목록·신청 폼·승인 트리거) | @Geuin04 | active (#100) | #100 #101 #102 #103 #104 #105 #106 #117 #118 #119 | [#189](https://github.com/JNU-SWCU/oss-hub/pull/189) (ready for review, `codex/issue-100-program-creation`) | Docker E2E 및 최신 CI pass | 없음 — 코어 스키마(done) 전제 충족 |
