...
| Program & Intake 백로그(10건: 프로그램 생성·편집·목록·상세·신청·팀 구성·신청자 목록·신청 폼·승인 트리거) | @Geuin04 | active (#100) | #100 #101 #102 #103 #104 #105 #106 #117 #118 #119 | draft 예정 (#100, `codex/issue-100-program-creation`) | local Docker E2E pass | 없음 — 코어 스키마(done) 전제 충족 |
