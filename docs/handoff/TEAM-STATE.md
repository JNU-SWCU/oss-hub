...
| Program.endAt 종료일 필드 | @GoBeromsu | review | [#264](https://github.com/JNU-SWCU/oss-hub/issues/264) | PR pending | backend 654 · frontend 전체 · lint/typecheck/build pass | 직렬 schema migration(nullable, backfill 없음) · endAt >= applicationEndAt 검증 · 공개 적격성(#126/#134) 선행 |
