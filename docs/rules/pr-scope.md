...
[AGENTS.md Code Conventions](../../AGENTS.md#code-conventions--common-patterns)의 커밋 단위 규칙("및·그리고"가 들어가면 쪼갠다)을 PR 단위로 확장한 것이다.
...
- 하위 PR의 Draft 허용 여부와 해제 조건은 [AGENTS.md Code Conventions](../../AGENTS.md#code-conventions--common-patterns)가 원본이다 — 이 문서는 그 규칙을 복사하지 않는다.
