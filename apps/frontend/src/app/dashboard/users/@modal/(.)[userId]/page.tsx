...
// 목록(`/dashboard/users`)에서 행을 소프트 클릭했을 때만 매칭되는 intercepting
// route(PR04F) — `(.)[userId]`는 같은 세그먼트 레벨(`app/dashboard/users/`)의
// `[userId]` 표준 상세를 가로챈다. URL은 표준 상세 주소
// (`/dashboard/users/[userId]`) 그대로 유지되고, 하드 새로고침·직접 진입은
