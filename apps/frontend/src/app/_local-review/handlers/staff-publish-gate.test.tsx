 ...
 * 이미 지나간 것이 된다.
 *
 * 시각을 고정(freeze)하지 않는 것이 핵심이다 — 고정하면 「종료일이 지나면 서버는
 * 정말로 종료로 본다」는 사실까지 가려져 픽스처가 언제부터 거짓인지 아무도 모르게 된다.
 * 대신 지금 시각과 달력 끝 **두 번** 대조해서, 달력이 흐른다고 판정이 달라지는
 * 픽스처를 그 자리에서 RED 로 만든다(#812).
 */
