...
import { BoardPostDetailRecord } from '../board.repository';
...
export class BoardPostDetailResponseDto {
  ...
  private constructor(record: BoardPostDetailRecord) {
    this.id = record.id;
  ...
  static from(record: BoardPostDetailRecord): BoardPostDetailResponseDto {
