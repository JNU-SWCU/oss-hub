...
export const EXPECTED_PUBLIC_AUTH_ROUTES = [
  ...
  route('GET', '/api/v1/programs/:id/cover/:coverId', 'PUBLIC'),
...
export const EXPECTED_AUTH_ROUTE_INVENTORY = [
  ...
  'PROTECTED DELETE /api/v1/programs/:programId/teams/:teamId',
  'PROTECTED DELETE /api/v1/programs/:programId/teams/:teamId/members/:userId',
  'PROTECTED DELETE /api/v1/programs/:programId/teams/me',
  'PROTECTED DELETE /api/v1/programs/:programId/teams/me/members/:userId',
  ...
  'PROTECTED GET /api/v1/milestones/:id/edit',
  ...
  'PROTECTED GET /api/v1/milestones/:milestoneId/documents/:documentId/applications/:applicationId/history',
  'PROTECTED GET /api/v1/milestones/:milestoneId/documents/:documentId/history',
  ...
  'PUBLIC GET /api/v1/programs/:id/cover/:coverId',
  ...
  'PROTECTED GET /api/v1/programs/:programId/applications/me/repository-url',
  'PROTECTED GET /api/v1/programs/:programId/board/posts',
  'PROTECTED GET /api/v1/programs/:programId/board/posts/:postId',
  'PROTECTED GET /api/v1/programs/:programId/documents/collection/archive',
  ...
  'PROTECTED PATCH /api/v1/programs/:programId/applications/me/repository-url',
  ...
  'PROTECTED POST /api/v1/program-authoring/cover-uploads',
  'PROTECTED POST /api/v1/program-authoring/notice-preview',
  ...
  'PROTECTED POST /api/v1/submission-files/checks',
