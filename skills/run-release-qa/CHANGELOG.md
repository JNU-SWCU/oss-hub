...
- 2026-09-23 — v1.2.1: 기록 조회가 QA 출처를 제목의 `QA<번호>`로 정해, 번호 없는 새 Issue를 빠뜨렸다 → 식별자는 GitHub `#Issue번호`다. 제목의 `QA<n>`은 옛 티켓을 찾을 때의 선택 조회이며 필수가 아니다. Provenance: 2026-09-23 운영자 정정 — QA 번호 수동 부여를 걷을 것.
