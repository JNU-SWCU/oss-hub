...
Issue·PR 코멘트로 제안한다. 2시간을 넘길 것으로 예상되거나 요구사항·설계·위험이 불확실한 작업은
...
Hermes를 포함한 독립 리뷰는 적용되는 `AGENTS.md`·팀 컨벤션 준수, 중복 구현, 기존 라이브러리·
...
분류한다. 독립 리뷰는 제품·기술 정책을 대신 결정하거나 CI·required review를 대체하지 않는다.
