...
QA 티켓 관리 워크플로의 원본은 `skills/manage-qa-tickets/SKILL.md`다 — `.cursor/skills/manage-qa-tickets`와 `.claude/skills/manage-qa-tickets`는 이 원본을 가리키므로 checkout만으로 Cursor·Claude가 스킬을 찾는다.
